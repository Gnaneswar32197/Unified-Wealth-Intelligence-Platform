...
export default function Navbar() {
  return (
    <header className="border-b border-gray-850 bg-gray-950/95 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <nav className="flex items-center gap-4 text-sm text-gray-300">
          ...
          <Link to="/register" className="rounded-full border border-gray-850 px-4 py-2 transition hover:border-emerald-500 hover:text-emerald-300">
            Register
          </Link>
        </nav>
      </div>
